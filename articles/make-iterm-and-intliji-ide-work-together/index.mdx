...
description: "Configure iTerm to open files in any of JetBrains IDEs"
date: "2022-01-06"
---

![pipe image](./hero.jpg)

> This instruction should work for all of the JetBrains IDE (IntelliJ IEDA, WebStorm, PhpStorm, PyCharm).
...
When it comes to macOS terminal apps, the most popular pick is iTerm. It's famous for its amazing features and flexible customization. But unfortunately, by default, iTerm cannot open files in the JetBrains IDEs using ⌘ + Click (it works by default with VSCode thought). But there is a way to fix that.
