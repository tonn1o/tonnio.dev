...
**Remark 1:**
In this article, when I address “store” I usually mean “Flux architecture” and its implementation represented by Redux.
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">I don’t like Redux very much, but this sounds like the opposite of its problems? With Redux, you *do* know deterministically where the code lies because you can follow the reducer chain. The problem is that what should’ve been local often becomes global.</p>&mdash; Dan (@dan_abramov) <a href="https://twitter.com/dan_abramov/status/1241756566048694272?ref_src=twsrc%5Etfw">March 22, 2020</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
![good and bad practice](./scheme.jpg)
